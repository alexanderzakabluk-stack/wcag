...
#wcag-app .ew { color: rgba(255,255,255,.52); }
...
#wcag-app .winput-group { max-width: 560px; width: 100%; }
#wcag-app .wurl-field {
...
#wcag-app .wresults-inner { max-width: 720px; margin: 0 auto; padding: 56px 24px 0; }
...
#wcag-app .wpowered-row  { text-align: center; font-size: 10px; color: #d0d0d0; letter-spacing: 0.14em; text-transform: uppercase; padding: 24px 0 0; }

/* ── STATE 4 · GATE ── */
#wcag-app #wgate { background: var(--grey-bg); padding: 56px 24px; border-top: 1px solid var(--border); }
#wcag-app .wgate-inner { max-width: 600px; margin: 0 auto; }
...
@media (min-width: 768px) {
  #wcag-app #ws-input   { padding: 72px 56px 80px; }
  #wcag-app .whero-title { font-size: 52px; }
  #wcag-app .wbtn { width: auto; }
  #wcag-app #wscan-btn, #wcag-app #wgate-btn { width: 100%; max-width: 560px; }
  #wcag-app .wresults-inner { padding: 64px 48px 0; }
  #wcag-app .wform-rows { grid-template-columns: 1fr 1fr; }
  #wcag-app .wfield-phone { grid-column: 1 / -1; }
  #wcag-app #wgate { padding: 64px 48px; }
}
...
<div id="ws-input" class="wstate active wphoto-bg">
  <div class="whero-inner">
    ...
    <div class="winput-group">
      ...
      <button class="wbtn" id="wscan-btn" onclick="wcagHandleScan()" style="max-width:560px;width:100%;">SKANNA MIN WEBBPLATS &rarr;</button>
